...
def generate_sb_table():
	gold_path = 'chartssenta/all_gold/'
	test_path = '/mnt/Backup/simina/output_files_aws/inference_only_20200629025149/chartssb/results/test/'
	valid_path = '/mnt/Backup/simina/output_files_aws/20200628222148/chartssb/results/loads/52/valid/'
